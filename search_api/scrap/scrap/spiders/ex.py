...
class ScrapoSpider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [f"https://www.googleapis.com/customsearch/v1?q={self.query} for {self.level} &key=AIzaSyCIKEESnF7bt6Zu5HmM2S58amw5BddUm8M&cx=c7e776d141aa547c6&start=1&gl=us",
                f"https://www.googleapis.com/customsearch/v1?q={self.query} for {self.level} &key=AIzaSyCIKEESnF7bt6Zu5HmM2S58amw5BddUm8M&cx=c7e776d141aa547c6&start=11&gl=us",
        ]
        for url in urls:
